      ...
      <section className="h-screen min-h-[750px] max-[640px]:min-h-[600px] relative overflow-hidden flex flex-col justify-center p-[100px_80px_100px] max-[1100px]:p-[80px_28px_64px]">
        <div className="absolute inset-0 z-0">
          <Image 
            ...
            alt="Strategic commercial real estate transactions" 
            fill 
            priority 
        ...
        <div className="relative z-[3] max-w-[940px]">
          <h2 className="font-serif text-[clamp(24px,3.2vw,46px)] font-light text-white mb-10 animate-fadeUp-d3 leading-[1.15]">
            Make Every Commercial Property <em className="italic text-gold">Decision Count</em>
          </h2>
