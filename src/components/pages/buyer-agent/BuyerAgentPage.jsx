    ...
    <main>
      ...
      <section className="h-screen min-h-[750px] max-[640px]:min-h-[600px] relative overflow-hidden flex flex-col justify-center p-[100px_80px_100px] max-[1100px]:p-[80px_28px_64px]">
        ...
        <div className="relative z-[3] max-w-[840px]">
          <h1 className="font-serif text-[clamp(32px,4vw,64px)] font-light leading-[1.2] tracking-[-0.01em] text-white mb-8 animate-fadeUp-d2">
              ...
              <div className="bg-white p-12 shadow-[0_32px_64px_rgba(0,0,0,.04)] border-t-2 border-gold/30">
                ...
                <div className="pt-8 border-t border-dark/[0.08] space-y-6">
                  <p className="text-base text-mid font-light leading-relaxed">
                    Buying a house without a real estate agent can be costly. Partner with our experts to make smart, confident decisions. We secure your capital, structure your offer intelligently, and make sure your purchase is in line with your long-term objectives.
                  </p>
                </div>
              </div>
            </div>
                  ...
                  <div className="relative border border-white/10 p-12 bg-white/[0.02] backdrop-blur-sm">
                    ...
                    <div className="pt-8 border-t border-white/10">
                      <p className="text-[15px] text-white/70 font-light italic leading-relaxed">
                        Every term in a contract affects your financial outcome. We ensure those terms favor you.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="max-w-[1100px] mx-auto">
            ...
            <div className="grid grid-cols-3 gap-px bg-white/10 max-[900px]:grid-cols-1 border border-white/10">
              {[
                ...
                <div key={i} className="bg-dark p-12 hover:bg-white/[0.03] transition-colors group flex items-center justify-center text-center h-[200px]">
                  <h3 className="font-serif text-2xl text-white group-hover:text-gold transition-colors">{type.title}</h3>
                </div>
              ))}
            </div>
          </div>
              ...
              <div className="space-y-24">
                ...
                <div className="flex gap-10 group">
                  ...
                  <div className="pb-12 border-b border-dark/5 w-full">
                    ...
                    <p className="text-[15px] text-mid font-light leading-[1.8] mb-8">
                      We do not waste your time with unqualified listings. Our search is strategic and curated.
                    </p>
                ...
                <div className="flex gap-10 group">
                  ...
                  <div className="pb-12 border-b border-dark/5 w-full">
                    ...
                    <p className="text-[14px] text-mid italic mt-8 font-light">The goal is simple: secure the property without overexposing your capital.</p>
                  </div>
                </div>
